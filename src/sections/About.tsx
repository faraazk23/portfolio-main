      ...
      <Section id="about" title="About Me">
        <Row>
          {/* <Col md={2}> */}
            ...
            {/* </Row> */}
          {/* </Col> */}
          <Col md={12} className="triangle-left-md triangle-top-sm">
              ...
              <Row>
                <Col md={8}>
                  ...
                  <div className="mt-3 mb-3">
                    ...
                    { /*<a href="https://youtu.be/pSr27wxHtEA" className="btn btn-kd" target="_blank" rel="noopener noreferrer">View on Youtube</a> */}
                  </div>
                  <div dangerouslySetInnerHTML={ { __html: about.objectiveNext } } />
                </Col>
                <Col md={4}>
